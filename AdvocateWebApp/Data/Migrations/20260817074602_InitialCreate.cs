        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThumbnailImageUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    PDFDocumentUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThumbnailImageUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    PDFDocumentUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsFeatured = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PracticeAreaServices", x => x.Id);
                });
